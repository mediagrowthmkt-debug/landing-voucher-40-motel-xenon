...
const VOUCHER_MESSAGE = `Olá! Vim pela campanha da Copa do Motel Xenon e quero ver suítes disponíveis com vinho cortesia. Vim pelo Google`;
    ...
    if (ctaButton) {
        ctaButton.addEventListener('click', function() {
            ...
            if (typeof gtag === 'function') {
                gtag('event', 'click', {
                    'event_category': 'CTA',
                    'event_label': 'Copa Vinho WhatsApp',
                    'value': 1
                });
            }
        });
